...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : '62895360006171';
...
module.exports = {
  sessionName: process.env.SESSION_ID || "VAJIRA;;;WreckerHoover",      //Put Your Session Id Here
  botname: process.env.BOT_NAME || 'siesta bot',
  ...
  caption :process.env.CAPTION || "```||| hi,its siesta bot,ready for your ||```",   //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@suhailtechinfo0"),
